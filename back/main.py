...
from routes import user_router, cards_router, company_router, login_router, logs_router, imagen_company_router
...
app.include_router(imagen_company_router.router, tags=["Imgenes Compañia"], prefix="/imgs_company")